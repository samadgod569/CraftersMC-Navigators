...
const { TOOL_SCHEMA } = require("./tools");
...
const SYSTEM_HEADER = `You are Nyxo Code, an expert AI coding agent. You run in a terminal.
...
function buildPrompt(history, userMessage) {
  ...
  const system = SYSTEM_HEADER.replace("{cwd}", cwd);
