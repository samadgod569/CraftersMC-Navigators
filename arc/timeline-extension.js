...
(function () {
  ...
  function hookSaveButton() {
    ...
    if (btn.dataset.timelineHooked) return;
    btn.dataset.timelineHooked = '1';

    /* Replace the button's onclick handler entirely */
    btn.removeAttribute('onclick');
    btn.addEventListener('click', timelineSave);
  }
  ...
  async function timelineSave() {
    const fmCurrentFile = window.fmCurrentFile;
